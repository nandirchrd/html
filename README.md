...
| 34. | `<dfn>` | Specifies a term that is going to be defined within the content | ✔️ |
...
| 71. | `<noframes>` | Defines navigation links | ❌ |
...
| 108. | `<th>` | Defines a header cell in a table | ✔️ |
...
| 80. | ondragstart | All visible elements | - |
